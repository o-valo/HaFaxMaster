...
##### Fax-Dienst:
 Auf dem Windows-System muss ein funktionierendes Fax-System eingerichtet sein (z. B. Windows Fax-Dienst mit Modem oder eine kompatible Fax-Software).
...
---
   ...
   `TARGET_DIR:` Der lokale GVFS-Mountpfad unter Linux (z. B. 
`/run/user/$(id -u)/gvfs/smb-share:server=<IP>,share=<FREIGABE>,user=<USER>).`
